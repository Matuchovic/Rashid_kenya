        ...
        {CONTACTS.map((c, i) => (
          ...
          >
            <div style={{
              ...
              background:c.color, border:`0.5px solid ${c.border}`,
              display:'flex', alignItems:'center', justifyContent:'center',
              fontSize:18,
            }}>{c.icon}</div>
            <div>
              <div style={{ fontSize:12, color:'#F2E6D0', letterSpacing:'0.04em', marginBottom:2 }}>{c.label}</div>
              <div style={{ fontSize:10, color:'rgba(242,230,208,0.35)', letterSpacing:'0.06em' }}>{c.sub}</div>
            </div>

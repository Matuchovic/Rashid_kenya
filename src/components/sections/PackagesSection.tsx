...
const PACKAGES: Pkg[] = [
  ...
  { id:'ngutuni1', name:'One Day Ngutuni Safari', duration:'1 Day', tag:'Day Safari', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Drinking Water'], img:'/pkg-tsavo-landscape.jpg' },
  { id:'tsavo2', name:'2 Days / 1 Night Tsavo East', duration:'2 Days', tag:'Overnight', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Accommodation','All Meals','Drinking Water'], img:'/pkg-night-lodge.jpg' },
  { id:'ngutuni2', name:'2 Days / 1 Night Ngutuni', duration:'2 Days', tag:'Overnight', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Accommodation','All Meals','Drinking Water'], img:'/pkg-lion-night.jpg' },

...
const PACKAGES: Pkg[] = [
  { id:'tsavo1', name:'One Day Tsavo East Safari', duration:'1 Day', tag:'Day Safari', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Drinking Water'], img:'/pkg-tsavo-sign.jpg' },
  { id:'ngutuni1', name:'One Day Ngutuni Safari', duration:'1 Day', tag:'Day Safari', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Drinking Water'], img:'/pkg-safari-jeep.jpg' },
  { id:'tsavo2', name:'2 Days / 1 Night Tsavo East', duration:'2 Days', tag:'Overnight', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Accommodation','All Meals','Drinking Water'], img:'/pkg-tsavo1.jpg' },
  { id:'ngutuni2', name:'2 Days / 1 Night Ngutuni', duration:'2 Days', tag:'Overnight', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','Accommodation','All Meals','Drinking Water'], img:'/pkg-tsavo-landscape.jpg' },
  { id:'saltlick', name:'2 Days Salt Lick Lodge', duration:'2 Days', tag:'Luxury Lodge', category:'safari', highlight:true,
    includes:['4×4 Jeep & Guide','Park Entry Fees','Salt Lick Lodge','All Meals','Drinking Water'], img:'/pkg-lodge-sunset.jpg' },
  ...
  { id:'tsavo3combo', name:'3 Days Tsavo East & Salt Lick', duration:'3 Days', tag:'Premium', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','2× Accommodation','All Meals','Drinking Water'], img:'/pkg-night-lodge.jpg' },
  { id:'tsavoboth', name:'3 Days Tsavo East & West', duration:'3 Days', tag:'Premium', category:'safari',
    includes:['4×4 Jeep & Guide','Park Entry Fees','2× Accommodation','All Meals','Drinking Water'], img:'/pkg-lion-night.jpg' },
  ...
  { id:'shimba', name:'Shimba Hills National Reserve', duration:'Full Day', tag:'Nature', category:'excursion', highlight:true,
    includes:['Transport','Park Fees','Game Drive','Waterfall Hike','Armed Ranger','Lunch'], img:'/pkg-safari-sunset.jpg' },

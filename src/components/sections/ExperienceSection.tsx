  ...
  return (
    <section ref={ref} style={{ position:'relative', minHeight:'80svh', overflow:'hidden', display:'flex', alignItems:'center' }}>
      ...
      <div style={{ position:'relative', zIndex:10, padding:'clamp(48px,8vh,100px) clamp(20px,6vw,60px)', maxWidth:640 }}>
        ...
        <p className="xi" style={{ opacity:0, transform:'translateY(20px)', transition:'all 0.8s cubic-bezier(0.25,1,0.5,1)', fontSize:'clamp(12px,1.5vw,14px)', lineHeight:1.8, color:'rgba(242,230,208,0.45)', maxWidth:400, marginBottom:28 }}>

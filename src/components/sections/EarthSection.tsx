  ...
  return (
    <section ref={ref} style={{ position:'relative', minHeight:'100svh', background:'#000', overflow:'hidden', display:'flex', alignItems:'center' }}>
      ...
      <style>{`
        ...
        @keyframes kPill{0%{stroke-dashoffset:0;stroke:rgba(255,248,180,0)}5%{stroke:rgba(255,248,180,0.95)}88%{stroke:rgba(212,167,95,0.5)}100%{stroke-dashoffset:-60;stroke:rgba(255,248,180,0)}}
        ...
        @media(max-width:768px){
          .earth-grad-desktop{display:none!important}
        }
      `}</style>
    </section>
  )

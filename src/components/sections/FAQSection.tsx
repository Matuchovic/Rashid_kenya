...
const FAQS = [
  { qKey: 'faq_q1', aKey: 'faq_a1', q: 'When is the best time to visit Kenya?', a: 'The best time is during the dry seasons: January to February and June to October. July to September is peak season. Year-round is possible.' },
  { qKey: 'faq_q2', aKey: 'faq_a2', q: 'What should I pack for a safari?', a: 'Light neutral clothing, a good hat, sunscreen, insect repellent, binoculars and a camera. Rashid provides all safari equipment.' },
  { qKey: 'faq_q3', aKey: 'faq_a3', q: 'Is safari safe for children?', a: 'Absolutely. Rashid has extensive experience with families. Game drives in a secure 4x4. Minimum recommended age is 5 years.' },
  { qKey: 'faq_q4', aKey: 'faq_a4', q: 'How does payment work?', a: 'We discuss everything via WhatsApp first. Payment is flexible: bank transfer, cash or other arrangements. No hidden fees.' },
  { qKey: 'faq_q5', aKey: 'faq_a5', q: 'How big are the groups?', a: 'All safaris are private: just you, your companions and Rashid. No joining strangers. Full flexibility on timing and routes.' },
  { qKey: 'faq_q6', aKey: 'faq_a6', q: 'Do I need vaccinations?', a: 'Yellow fever vaccination is recommended. Malaria prophylaxis is advised. Consult your doctor 4 to 6 weeks before travel.' },
]
...
export function FAQSection() {
  ...
  return (
    <section id="faq" style={{ background: '#050505', padding: 'clamp(60px,8vh,100px) 0', borderTop: '0.5px solid rgba(212,167,95,0.06)' }}>
      ...
      <div style={{ textAlign: 'center', padding: '0 clamp(20px,5vw,48px)', marginBottom: 'clamp(40px,6vh,56px)' }}>
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: 'clamp(28px,5vw,48px)', fontWeight: 200, color: '#F2E6D0', lineHeight: 1, margin: 0 }}>
          {t('faq_title')}<br />
          <em style={{ color: '#D4A75F', fontStyle: 'italic' }}>{t('faq_title_em')}</em>
        </h2>
      </div>
            ...
            >
              ...
              <span style={{ flexShrink: 0, width: 28, height: 28, borderRadius: '50%', border: open === i ? '0.5px solid rgba(212,167,95,0.6)' : '0.5px solid rgba(212,167,95,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s ease', background: open === i ? 'rgba(212,167,95,0.1)' : 'transparent' }}>
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <line x1="6" y1="0" x2="6" y2="12" stroke="#D4A75F" strokeWidth="0.8" style={{ opacity: open === i ? 0 : 1, transition: 'opacity 0.3s' }} />
